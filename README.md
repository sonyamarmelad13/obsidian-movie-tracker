## 📖 О проекте
Всем салют, хочу представить вам мою модель кинотеки для Obsidiana, созданную с помощью плагина Dataview. Изначально создавал чисто для себя, но может кому-то тоже будет полезно, поэтому решил выложить сюда. Код целиком и полностью написан с помощью Claude.
